...
export const searchUseStylesLessThan480 = makeStyles((theme) => createStyles({
  root: {
    width: 'auto',
    padding: '0px 10px',
  },
...
export const searchUseStylesGreaterThan480 = makeStyles((theme) => createStyles({
  root: {
    width: 'clamp(480px, 100%, 1000px)',
    padding: '0px 10px',
  },
...
export const backButtonUseStyles = makeStyles((theme) => createStyles({
  backButton: {
    fontSize: '2em',
...
export const profileUseStyles = makeStyles((theme) => ({
  ...
  backgroundImage: {
    height: '200px',
    backgroundImage: 'linear-gradient(to top right, rgba(0,0,0,1), rgba(0,0,0,0)), url(https://img.luzernerzeitung.ch/2018/4/13/1ccb8633-0f8b-4a08-ae12-9c70e9220fd3.jpeg)',
